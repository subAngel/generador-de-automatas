...
public class AFD implements Cloneable, Proceso {
    ...
    public HashSet<Character> estadosFinales;
    public String estadoInicial ;
    public HashSet<TransicionAFD> transiciones;
     ...
     */
    public void setEstadosFinales(HashSet<Character> estadosFinales) {
     ...
     * @return
     */
    public HashSet<Character> getEstadosFinales() {
     ...
     * @param estadoFinal
     */
    public void addEstadoFinal(char estadoFinal) {
    ...
    public void eliminarEstado(String e) //Eliminar las transiciones que usan ese estado
    {
        ...
        for (TransicionAFD t : this.transiciones) {
            if (t.getEstadoO()==(e) || t.getEstadoD()==(e)) //Si aparece en el origen o destino de una transicion
            {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        for (char estado : this.estadosFinales) {
